...
{
    public class <xsl:value-of select="$EntityName"/>DtoValidator : AbstractValidator&lt;<xsl:value-of select="$EntityName"/>Dto&gt;
    {
		...
		public <xsl:value-of select="$EntityName"/>DtoValidator(
